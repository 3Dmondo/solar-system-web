...
const textureUrls: Partial<Record<BodyId, string>> = {
  ...
  phobos: new URL('../../../../assets/textures/2k_phobos.jpg', import.meta.url).href,
  deimos: new URL('../../../../assets/textures/2k_deimos.jpg', import.meta.url).href,
  jupiter: new URL('../../../../assets/textures/2k_jupiter.jpg', import.meta.url).href,
  io: new URL('../../../../assets/textures/2k_io.jpg', import.meta.url).href,
  europa: new URL('../../../../assets/textures/2k_europa.jpg', import.meta.url).href,
  ...
  mimas: new URL('../../../../assets/textures/2k_mimas.jpg', import.meta.url).href,
  enceladus: new URL('../../../../assets/textures/2k_enceladus.jpg', import.meta.url).href,
  tethys: new URL('../../../../assets/textures/2k_tethys.jpg', import.meta.url).href,
  dione: new URL('../../../../assets/textures/2k_dione.jpg', import.meta.url).href,
  ...
  ariel: new URL('../../../../assets/textures/2k_ariel.jpg', import.meta.url).href,
  ...
  miranda: new URL('../../../../assets/textures/2k_miranda.jpg', import.meta.url).href,
